<?php 
	...
	$higiene_m= mysql_query("SELECT * FROM higiene_mascotas WHERE id=$idhigiene_m");
	
	while($fila = mysql_fetch_array($higiene_m)){
			$nombre = $fila['nombre'];
	...
	<body>
		...
		<div id="informacion_producto">
			...
			<div class="imagen_producto">
					<img  src="img/productos/mascotas/higiene/<?php echo $imagen;?>" />	
