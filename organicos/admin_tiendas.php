...
<body id="main_body" >
	...
	<div id="form_container">
		...
		<h1><a>Tiendas</a></h1>
		<form id="form_939431" class="appnitro" enctype="multipart/form-data" method="POST" action="insertar_tiendas.php">
		...
		<div>
			<textarea id="ubicacion" name="ubicacion" class="element textarea medium"></textarea> 
		</div> 
		<!--</li>		<li id="li_4" >
		<label class="description" for="poster">imagen </label>
		<div>
			<input id="poster" name="poster" class="element file" type="file"/> 
		</div>  
		</li>-->
			
					<li class="buttons">
			    <input type="hidden" name="form_id" value="939431" />
